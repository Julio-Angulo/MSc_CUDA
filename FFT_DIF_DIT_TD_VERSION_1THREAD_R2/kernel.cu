...
int main()
{
    ...
    da = fopen("Resultados_radix_2_real_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_radix_2_imag_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
	dc = fopen("Entrada_radix_2_CUDA_1thread.txt","w+t"); //Crea o sobre escribe archivo
	//dd = fopen("TIEMPOS_FFT_DIF_DIT_TD_SECUENCIAL_CUDA.bin","a+b"); //Crea o sobre escribe archivo
	fi_1 = fopen("Flag_inputstage_1_radix_2_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
	fi_2 = fopen("Flag_inputstage_2_radix_2_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
	fi_3 = fopen("Flag_inputstage_3_radix_2_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
	fo_1 = fopen("Flag_outputstage_1_radix_2_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
    fo_2 = fopen("Flag_outputstage_2_radix_2_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
    fo_3 = fopen("Flag_outputstage_3_radix_2_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
