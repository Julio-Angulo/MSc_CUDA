...
///(21/01/2017)
///Ésta versión sirve para graficar en matlab los errores absolutos y relativos Caso: N=(2^5)x(3^4)x(5^4), Li=N, Lo=800,000
...
int main()
{
	...
	da = fopen("Resultados_NCompuesta_LiN_Lo800000_real_CUDA_DO.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_NCompuesta_LiN_Lo800000_imag_CUDA_DO.bin","a+b"); //Crea o sobre escribe archivo
