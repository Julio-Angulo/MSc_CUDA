...
///(29/12/2016)
///Ésta versión sirve para graficar en matlab los tiempos de ejecución, considerando N = (2^5 x 3^4 x 5^4), Li = varía y Lo = 800,000
...
int main()
{
	...
	if(device == 0)
	{
		...
		da = fopen("Tiempos_NCompuesta_LiVARIA_Lo850000_CUDA_GTX970.bin","a+b"); //Crea o sobre escribe archivo
	}
	if(device == 1)
	{
		printf("\n\n---DEVICE = TESLA K20---\n\n");
		da = fopen("Tiempos_NCompuesta_LiVARIA_Lo850000_CUDA_TESLAK20c.bin","a+b"); //Crea o sobre escribe archivo
	}
	//////////////////////////////////////////////////////////////////////////
