...
///(29/08/2016)
///Ésta versión sirve para encontrar en matlab el número de iteraciones necesario, considerando (RADIX-2) N = 1024, Li = N y Lo = {2,4,8,...,1024}
...
int main()
{
	...
	for(i_N = N_max;i_N <= N_max;i_N++)
    {
		...
		for(j_res=(int )pow(2,Li_max);j_res <= (int )pow(2,Li_max);j_res++)
        {
            Li=j_res;
			for(k_res=1;k_res <= N_max;k_res++)
            {
			   ...
			   case 1:
				   ...
				   da = fopen("Acomulados_N1024_LiN_Lo2.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo2.bin","a+b");
				   break;
				case 2:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_LiN_Lo4.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo4.bin","a+b");
				   break;
				case 3:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_LiN_Lo8.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo8.bin","a+b");
				   break;
				case 4:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_LiN_Lo16.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo16.bin","a+b");
				   break;
				case 5:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_LiN_Lo32.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo32.bin","a+b");
				   break;
				case 6:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_LiN_Lo64.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo64.bin","a+b");
				   break;
				case 7:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_LiN_Lo128.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo128.bin","a+b");
				   break;
				case 8:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_LiN_Lo256.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo256.bin","a+b");
				   break;
				case 9:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_LiN_Lo512.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo512.bin","a+b");
				   break;
				case 10:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_LiN_Lo1024.bin","a+b");
				   db = fopen("Promedios_N1024_LiN_Lo1024.bin","a+b");
				   break;
