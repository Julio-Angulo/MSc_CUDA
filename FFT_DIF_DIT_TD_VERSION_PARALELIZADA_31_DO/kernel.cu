...
///(21/01/2017)
///Ésta versión sirve para graficar en matlab los errores absolutos y relativos Caso: N=(2^5)x(3^4)x(5^4), Li=800,000, Lo=N
...
int main()
{
	...
	da = fopen("Resultados_NCompuesta_Li800000_LoN_real_CUDA_DO.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_NCompuesta_Li800000_LoN_imag_CUDA_DO.bin","a+b"); //Crea o sobre escribe archivo
