...
///(19/01/2017)
///Grafica en Matlab los tiempos de ejecución, considerando Radix-2. N = 2^20, Li = {2, 4,…,N}, Lo= 33. (precisión doble).
...
int main()
{
	...
	if(device == 1)
	{
		...
		da = fopen("Tiempos_N20_LiVARIA_Lo33_CUDA_GTX970_DO.bin","a+b"); //Crea o sobre escribe archivo
	}
	if(device == 0)
	{
		printf("\n\n---DEVICE = TESLA K20---\n\n");
		da = fopen("Tiempos_N20_LiVARIA_Lo33_CUDA_TESLAK20c_DO.bin","a+b"); //Crea o sobre escribe archivo
	}
	//////////////////////////////////////////////////////////////////////////
