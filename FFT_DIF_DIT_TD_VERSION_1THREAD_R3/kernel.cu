///Ésta programa calcula la versión 1 thread del algoritmo FFT_DIF_DIT_TD
///(24/08/2016)
///Ésta versión sirve para graficar en matlab los errores absolutos y relativos (RADIX-3) 3^1 - 3^6
...
int main()
{
	int i,j,alea_real[729],alea_imag[729],i_N,l_res,j_res,k_res,incremento_j;
	//float suma;
    ...
    da = fopen("Resultados_radix_3_real_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_radix_3_imag_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
	dc = fopen("Entrada_radix_3_CUDA_1thread.txt","w+t"); //Crea o sobre escribe archivo
	//dd = fopen("TIEMPOS_FFT_DIF_DIT_TD_SECUENCIAL_CUDA.bin","a+b"); //Crea o sobre escribe archivo
	fi_1 = fopen("Flag_inputstage_1_radix_3_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
	fi_2 = fopen("Flag_inputstage_2_radix_3_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
	fi_3 = fopen("Flag_inputstage_3_radix_3_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
	fo_1 = fopen("Flag_outputstage_1_radix_3_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
    fo_2 = fopen("Flag_outputstage_2_radix_3_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
    fo_3 = fopen("Flag_outputstage_3_radix_3_CUDA_1thread.bin","a+b"); //Crea o sobre escribe archivo
...
__global__ void outputStage_kernel(int N,int Lo,int Dip,int Dop,int P,cuFloatComplex *z,cuFloatComplex *W,cuFloatComplex *X,int *flag_outputstage_1_d,int *flag_outputstage_2_d,int *flag_outputstage_3_d)
{
	...
	cuFloatComplex t1,t2,t3,t4,t5,t4_aux,X_aux,X_aux_1;
	float t4_aux_1;
