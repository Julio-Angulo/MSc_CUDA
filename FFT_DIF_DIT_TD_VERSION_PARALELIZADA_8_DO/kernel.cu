...
///(18/01/2017)
///Grafica en Matlab los tiempos de ejecución, considerando Radix-2. N = 2^20, Li = 524,000, Lo= {2, 4,…,N}. (precisión doble).
...
int main()
{
	...
	if(device == 1)
	{
		...
		da = fopen("Tiempos_N20_Li524000_LoVARIA_CUDA_GTX970_DO.bin","a+b"); //Crea o sobre escribe archivo
	}
	if(device == 0)
	{
		printf("\n\n---DEVICE = TESLA K20---\n\n");
		da = fopen("Tiempos_N20_Li524000_LoVARIA_CUDA_TESLAK20c_DO.bin","a+b"); //Crea o sobre escribe archivo
	}
	//////////////////////////////////////////////////////////////////////////
