///Este programa calcula la versión paralelizada del algoritmo FFT_DIF_DIT_TD
///(29/08/2016)
///Ésta versión sirve para encontrar en matlab el número de iteraciones necesario, considerando (RADIX-3) N = 729, Li = 43 y Lo = {3,9,27,...,729}
		...
		for(j_res=Li_max;j_res <= Li_max;j_res++)
        {
			...
			for(k_res=1;k_res <= N_max;k_res++)
            {
			   ...
			   case 1:
				   ...
				   da = fopen("Acomulados_N729_Li43_Lo3.bin","a+b");
				   db = fopen("Promedios_N729_Li43_Lo3.bin","a+b");
				   break;
				case 2:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li43_Lo9.bin","a+b");
				   db = fopen("Promedios_N729_Li43_Lo9.bin","a+b");
				   break;
				case 3:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li43_Lo27.bin","a+b");
				   db = fopen("Promedios_N729_Li43_Lo27.bin","a+b");
				   break;
				case 4:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li43_Lo81.bin","a+b");
				   db = fopen("Promedios_N729_Li43_Lo81.bin","a+b");
				   break;
				case 5:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li43_Lo243.bin","a+b");
				   db = fopen("Promedios_N729_Li43_Lo243.bin","a+b");
				   break;
				case 6:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li43_Lo729.bin","a+b");
				   db = fopen("Promedios_N729_Li43_Lo729.bin","a+b");
				   break;
			   default:
				   break;
			   }
