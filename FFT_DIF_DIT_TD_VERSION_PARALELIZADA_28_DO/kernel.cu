...
///(21/01/2017)
///Ésta versión sirve para graficar en matlab los errores absolutos y relativos Caso: N^20, Li=524,000, Lo=524,000
...
int main()
{
	...
	da = fopen("Resultados_N20_Li524000_Lo524000_real_CUDA_DO.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_N20_Li524000_Lo524000_imag_CUDA_DO.bin","a+b"); //Crea o sobre escribe archivo
