...
///(31/08/2016)
///Ésta versión sirve para graficar en matlab los tiempos de ejecución, considerando (RADIX-2) N = 16,384, Li = N y Lo = {2,4,8,...,16384}
...
int main()
{
	...
	FILE *da;
	da = fopen("Tiempos_N16384_LiN_LoVARIA_CUDA_1THREAD.bin","a+b"); //Crea o sobre escribe archivo
