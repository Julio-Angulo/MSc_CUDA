...
///(31/08/2016)
///Grafica en Matlab los tiempos de ejecución, considerando Radix-2. N = 2^20, Li = N, Lo= {2, 4,…,N}. (precisión simple).
...
int main()
{
	...
	if(device == 0)
	{
		...
		da = fopen("Tiempos_N20_LiN_LoVARIA_CUDA_GTX970.bin","a+b"); //Crea o sobre escribe archivo
	}
	if(device == 1)
	{
		printf("\n\n---DEVICE = TESLA K20---\n\n");
		da = fopen("Tiempos_N20_LiN_LoVARIA_CUDA_TESLAK20c.bin","a+b"); //Crea o sobre escribe archivo
	}
	//////////////////////////////////////////////////////////////////////////
