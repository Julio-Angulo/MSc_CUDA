/* Este programa calcula la versión paralela de la libreria cuFFT (sin podado) para N= 2^20*/
/// (20/09/2016)
///Ésta versión sirve para graficar en matlab los tiempos de ejecución (RADIX-2) SIN PODAR N= 2^20
