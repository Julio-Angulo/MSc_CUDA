...
///(19/01/2017)
///Grafica en Matlab los tiempos de ejecución, considerando Radix-3. N = 3^13, Li = 797,000 , Lo= {3, 9,…,N}. (precisión doble).
...
int main()
{
	...
	if(device == 0)
	{
		...
		da = fopen("Tiempos_N13_Li797000_LoVARIA_CUDA_GTX970_DO.bin","a+b"); //Crea o sobre escribe archivo
	}
	if(device == 1)
	{
		printf("\n\n---DEVICE = TESLA K20---\n\n");
		da = fopen("Tiempos_N13_Li797000_LoVARIA_CUDA_TESLAK20c_DO.bin","a+b"); //Crea o sobre escribe archivo
	}
	//////////////////////////////////////////////////////////////////////////
