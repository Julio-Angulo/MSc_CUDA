...
///(14/09/2016)
///Ésta versión sirve para graficar en matlab los errores absolutos y relativos Caso: N^13, Li=264, Lo=N
...
int main()
{
	...
	da = fopen("Resultados_N13_Li264_LoN_real_CUDA.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_N13_Li264_LoN_imag_CUDA.bin","a+b"); //Crea o sobre escribe archivo
