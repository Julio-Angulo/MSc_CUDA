///Ésta programa calcula la versión paralelizada del algoritmo FFT_DIF_DIT_TD (VARIABLES TIPO DOUBLE)
///(04/01/2017)
///Ésta versión sirve para graficar en matlab los errores absolutos y relativos Caso: N^20, Li=N, Lo=524,000
...
const int Li_max = 1048576;

///Ingrese el valor de Lo_max
const int Lo_max = 524000;
...
int main()
{
	...
	da = fopen("Resultados_N20_LiN_Lo524000_real_CUDA_DO.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_N20_LiN_Lo524000_imag_CUDA_DO.bin","a+b"); //Crea o sobre escribe archivo
