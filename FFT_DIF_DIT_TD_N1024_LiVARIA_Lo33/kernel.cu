...
///(29/08/2016)
///Ésta versión sirve para encontrar en matlab el número de iteraciones necesario, considerando (RADIX-2) N = 1024, Li = {2,4,8,...,1024} y Lo = 33
		...
		for(j_res=1;j_res <= N_max;j_res++)
        {
			...
			for(k_res=Lo_max;k_res <= Lo_max;k_res++)
            {
			   ...
			   case 1:
				   ...
				   da = fopen("Acomulados_N1024_Li2_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li2_Lo33.bin","a+b");
				   break;
				case 2:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li4_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li4_Lo33.bin","a+b");
				   break;
				case 3:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li8_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li8_Lo33.bin","a+b");
				   break;
				case 4:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li16_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li16_Lo33.bin","a+b");
				   break;
				case 5:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li32_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li32_Lo33.bin","a+b");
				   break;
				case 6:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li64_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li64_Lo33.bin","a+b");
				   break;
				case 7:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li128_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li128_Lo33.bin","a+b");
				   break;
				case 8:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li256_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li256_Lo33.bin","a+b");
				   break;
				case 9:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li512_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li512_Lo33.bin","a+b");
				   break;
				case 10:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li1024_Lo33.bin","a+b");
				   db = fopen("Promedios_N1024_Li1024_Lo33.bin","a+b");
				   break;
