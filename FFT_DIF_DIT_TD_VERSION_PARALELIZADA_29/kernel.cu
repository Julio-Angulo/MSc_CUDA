...
///(04/01/2017)
///Ésta versión sirve para graficar en matlab los errores absolutos y relativos Caso: N^13, Li=N, Lo=264
...
int main()
{
	...
	da = fopen("Resultados_N13_LiN_Lo264_real_CUDA.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_N13_LiN_Lo264_imag_CUDA.bin","a+b"); //Crea o sobre escribe archivo
