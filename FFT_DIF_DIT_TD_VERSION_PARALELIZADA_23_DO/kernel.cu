...
///(19/01/2017)
///Grafica en Matlab los tiempos de ejecución, considerando N-Compuesta. N = (2^5)x(3^4)x(5^4), Li = N , Lo= Varía. (precisión doble).
...
int main()
{
	...
	if(device == 1)
	{
		...
		da = fopen("Tiempos_NCompuesta_LiN_LoVARIA_CUDA_GTX970_DO.bin","a+b"); //Crea o sobre escribe archivo
	}
	if(device == 0)
	{
		printf("\n\n---DEVICE = TESLA K20---\n\n");
		da = fopen("Tiempos_NCompuesta_LiN_LoVARIA_CUDA_TESLAK20c_DO.bin","a+b"); //Crea o sobre escribe archivo
	}
	//////////////////////////////////////////////////////////////////////////
