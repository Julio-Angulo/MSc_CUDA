...
///(29/08/2016)
///Ésta versión sirve para encontrar en matlab el número de iteraciones necesario, considerando (RADIX-3) N = 729, Li = {3,9,27,...,729} y Lo = 43
		...
		for(j_res=1;j_res <= N_max;j_res++)
        {
			...
			for(k_res=Lo_max;k_res <= Lo_max;k_res++)
            {
			   ...
			   case 1:
				   ...
				   da = fopen("Acomulados_N729_Li3_Lo43.bin","a+b");
				   db = fopen("Promedios_N729_Li3_Lo43.bin","a+b");
				   break;
				case 2:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li9_Lo43.bin","a+b");
				   db = fopen("Promedios_N729_Li9_Lo43.bin","a+b");
				   break;
				case 3:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li27_Lo43.bin","a+b");
				   db = fopen("Promedios_N729_Li27_Lo43.bin","a+b");
				   break;
				case 4:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li81_Lo43.bin","a+b");
				   db = fopen("Promedios_N729_Li81_Lo43.bin","a+b");
				   break;
				case 5:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li243_Lo43.bin","a+b");
				   db = fopen("Promedios_N729_Li243_Lo43.bin","a+b");
				   break;
				case 6:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N729_Li729_Lo43.bin","a+b");
				   db = fopen("Promedios_N729_Li729_Lo43.bin","a+b");
				   break;
			   default:
				   break;
			   }
