...
///(31/08/2016)
///Ésta versión sirve para graficar en matlab los tiempos de ejecución, considerando (RADIX-2) N = 2^20, Li = 307 y Lo = {2,4,8,...,2^20}
...
int main()
{
	...
	if(device == 0)
	{
		...
		da = fopen("Tiempos_N20_Li524000_LoVARIA_CUDA_GTX970.bin","a+b"); //Crea o sobre escribe archivo
	}
	if(device == 1)
	{
		printf("\n\n---DEVICE = TESLA K20---\n\n");
		da = fopen("Tiempos_N20_Li524000_LoVARIA_CUDA_TESLAK20c.bin","a+b"); //Crea o sobre escribe archivo
	}
