//Medición de tiempo para ejecutar una FFT 1D, radix-3. Se usará el comando "fftwf_plan_many_dft"
...
int main()
{
	...
	for(b=8;b<=8;b++)
	{
		...
		for(a=1;a<=loop;a++)
		{
			...
			time_fftw= fopen("time_fftw_radix3.bin","a+b");
