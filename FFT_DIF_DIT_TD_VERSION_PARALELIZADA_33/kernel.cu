...
int main()
{
	...
	da = fopen("Resultados_NCompuesta_Li850000_Lo850000_real_CUDA.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_NCompuesta_Li850000_Lo850000_imag_CUDA.bin","a+b"); //Crea o sobre escribe archivo
