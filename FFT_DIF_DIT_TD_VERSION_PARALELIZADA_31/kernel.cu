...
int main()
{
	...
	da = fopen("Resultados_NCompuesta_Li850000_LoN_real_CUDA.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_NCompuesta_Li850000_LoN_imag_CUDA.bin","a+b"); //Crea o sobre escribe archivo
