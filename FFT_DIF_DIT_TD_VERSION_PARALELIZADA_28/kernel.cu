...
///(04/01/2017)
///Ésta versión sirve para graficar en matlab los errores absolutos y relativos Caso: N^20, Li=307, Lo=N
...
const int Li_max = 307;

///Ingrese el valor de Lo_max
const int Lo_max = 307;
...
int main()
{
	...
	da = fopen("Resultados_N20_Li307_Lo307_real_CUDA.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_N20_Li307_Lo307_imag_CUDA.bin","a+b"); //Crea o sobre escribe archivo
