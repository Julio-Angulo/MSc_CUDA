...
///(29/08/2016)
///Ésta versión sirve para encontrar en matlab el número de iteraciones necesario, considerando (RADIX-2) N = 1024, Li = {2,4,8,...,1024} y Lo = N
...
int main()
{
	...
	for(i_N = N_max;i_N <= N_max;i_N++)
    {
        ...
        {
            Li=(int )pow(2,j_res);
			for(k_res=(int )pow(2,Lo_max);k_res <= (int )pow(2,Lo_max);k_res++)
            {
			   Lo=k_res;
			   printf("\n Li = %d  Lo = %d",Li,Lo);
			   ...
			   case 1:
				   ...
				   da = fopen("Acomulados_N1024_Li2_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li2_LoN.bin","a+b");
				   break;
				case 2:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li4_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li4_LoN.bin","a+b");
				   break;
				case 3:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li8_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li8_LoN.bin","a+b");
				   break;
				case 4:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li16_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li16_LoN.bin","a+b");
				   break;
				case 5:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li32_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li32_LoN.bin","a+b");
				   break;
				case 6:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li64_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li64_LoN.bin","a+b");
				   break;
				case 7:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li128_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li128_LoN.bin","a+b");
				   break;
				case 8:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li256_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li256_LoN.bin","a+b");
				   break;
				case 9:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li512_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li512_LoN.bin","a+b");
				   break;
				case 10:
				   	///Se crean los archivos binarios donde se guardarán los datos
				   da = fopen("Acomulados_N1024_Li1024_LoN.bin","a+b");
				   db = fopen("Promedios_N1024_Li1024_LoN.bin","a+b");
				   break;
