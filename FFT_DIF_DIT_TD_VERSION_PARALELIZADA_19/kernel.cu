...
int main()
{
	...
	da = fopen("Resultados_N20_Li307_LoN_real_CUDA.bin","a+b"); //Crea o sobre escribe archivo
    db = fopen("Resultados_N20_Li307_LoN_imag_CUDA.bin","a+b"); //Crea o sobre escribe archivo
